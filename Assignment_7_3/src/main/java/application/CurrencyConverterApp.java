...
public class CurrencyConverterApp extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            Scene scene = new Scene(view.getMainLayout(), 650, 550);

            primaryStage.setTitle("Currency Converter - JPA Enhanced (Assignment 7.3)");
            ...
            System.out.println("JPA Currency Converter Application started successfully");
    ...
    public static void main(String[] args) {
        System.out.println("Starting JPA Currency Converter Application...");
        launch(args);
    }
}