...
public class CurrencyConverterView {
    ...
    private VBox createHeader() {
        ...
        Label titleLabel = new Label("Currency Converter - JPA with Associations");
        titleLabel.setStyle("-fx-font-size: 24px; -fx-font-weight: bold; -fx-font-family: 'Arial', sans-serif; -fx-text-fill: #2c3e50;");

        Label instructionLabel = new Label("Transactions stored with JPA associations to Currency entities");
    ...
    private HBox createButtonSection() {
        ...
        convertButton = new Button("Convert & Store Transaction");
        convertButton.setStyle(
                "-fx-font-size: 14px; -fx-font-family: 'Arial', sans-serif; " +
                        "-fx-background-color: #4CAF50; -fx-text-fill: white; " +
                        "-fx-padding: 12px 20px; -fx-cursor: hand; -fx-background-radius: 5px;"
        );
